...
namespace DroneFactory {
    ...
    bool AudioTrack::isSoloed() const {
        return m_isSoloed.load();
    }

    void AudioTrack::setMuted(bool isMuted) {
        m_isMuted.store(isMuted);
    }

    void AudioTrack::setSoloed(bool isSoloed) {
        m_isSoloed.store(isSoloed);
    }
}